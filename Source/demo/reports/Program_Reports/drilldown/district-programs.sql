-- All Programs For a District (production)
-- This is a drilldown report that lists all programs for a given District
-- OPTIONS: {database: "sqlsvrprod"}
-- VARIABLE: { name: "district", display: "District" }
-- VARIABLE: { name: "when", display: "Filter", type: "select", options: ["All","Completed","Cancelled","Upcoming"], default:"All"}

	SELECT 	
	PROGRAM.PROGRAMID 
	,convert(varchar,PROGRAM.PROGDATE,101) AS 'Date'
