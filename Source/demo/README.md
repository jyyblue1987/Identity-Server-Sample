...
MEI reporting framework for managing and displaying nice looking, exportable reports from any data source, primarily SQL Server.
Capable to use mysql, application output and MongoDB.

Major features include:

*   Display a report from any data source that can output tabular data (SQL, MongoDB, code, and more)
...
For installation instructions and documentation, check out the original open source this is based on at http://jdorn.github.io/php-reports/
or forum - http://ost.io/@jdorn/php-reports
...
The framework ties together all these different report types, output formats, and meta-data into
...
Documentation
==============
For full documentation and information on getting started, see docs folder.
